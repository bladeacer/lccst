...
| Estimated tokens | 2130 | 8329 | +6199 (+291%) |
...
PASS tests/timer.test.tsx
  ...
  Timer
    ...
    ✓ stop() makes it not running (1 ms)
...
| Tokens | 838 | 5358 | +4520 (+539%) |
| Robustness | 48 | 83 | +35 |

#### File Details

**Plain files:**
- `plain/main.go`: 132 lines, ~838 tokens
...
### Token Overhead
Skill-guided approach uses ~+291% more tokens (6199 total).
